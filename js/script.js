...
newWidth; 
 ...
 function update(){ 
    ...
    generatePreview ='\n'
+'     <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="max-width:'+imgWidth+'px;">\n'
+'      <tr>\n'
...
+'                      <table role="presentation" border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="max-width:80%">\n'
+'                        <tr>\n'
+'                          <td style="padding:10px; font-family: Arial, sans-serif; font-size:14px;mso-line-height-rule: exactly;line-height: 21px;text-align:center;background-color: #e7e8f0;">\n'
+'                            <h1 style="font-family: Arial, sans-serif;font-size: 25px;mso-line-height-rule: exactly;line-height: 30px;color: #515BA3;margin:0;text-transform:uppercase;letter-spacing:3px">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor</h1>\n'
+'                          </td>\n'
+'                        </tr>\n'
+'                      </table>\n'
+'                    </td>\n'
